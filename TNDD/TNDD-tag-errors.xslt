...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:template match="chapter">
      <style type="text/css">
            	...
            	.ml1 {border-left:20pt solid orange;padding-left:3pt;padding-left:1em}
...
.error-p-no-content::after {content:'This paragraph mark is empty, and may not be allowed here.';}
.error-p-no-content {background:orange}
.error-p-not-allowed-here::after {content:'This paragraph mark is not be allowed here.';}
.error-p-not-allowed-here {background:orange}
.error-b-not-allowed-here::after {content:'This paragraph mark is not be allowed here.';}
.error-b-not-allowed-here {background:orange}
.error-sl1-post-1-not-ml1::after {content:'The paragraph following this paragraph should be \ml1';}
.error-sl1-post-1-not-ml1 {background:orange}
.error-ml1-post-1-not-ml2::after {content:'The paragraph before this paragraph should be \sl1 or \mlor';}
.error-ml1-post-1-not-ml2 {background:orange}
.error-ml1-post-1-not-ml3::after {content:'The paragraph before this paragraph should be \sl1 or \mlor';}
.error-ml1-post-1-not-ml3 {background:orange}
.error-mlor-text-not-lc-or::after {content:'The content of this field can only be -or-';}
.error-mlor-text-not-lc-or {background:orange}
.error-mlor-pre-not-ml1::after {content:'A \ml1 should preceed this \mlor';}
.error-mlor-pre-not-ml1 {background:orange}
.error-mlor-post-not-ml1::after {content:'A \ml1 should follow this \mlor';}
.error-mlor-post-not-ml1 {background:orange}
.error-brk-pre-not-imp::after {content:'This \brk should only occur immediately after an \imp* SFM.';}
.error-brk-pre-not-imp {background:orange}
.error-brk-post-not-imp::after {content:'This \brk should only occur before an \imp SFM.';}
.error-brk-post-not-imp {background:orange}
.error-brk-illegal-char::after {content:'This \brk has some extra non-allowed characters';}
.error-brk-illegal-char {background:orange}
.error-tr-2nd-not-allowed::after {content:'Only one \tr is allowed in this positions.';}
.error-tr-2nd-not-allowed {background:orange}
.error-tr-needs-one-tc1::after {content:'Must have one child \tc1';}
.error-tr-needs-one-tc1 {background:orange}
.error-tc1-no-1-tbb::after {content:'This style should have one \tbb __\tbb* sfm';}
.error-tc1-no-1-tbb {background:orange}
.error-tc1-no-2-sbx::after {content:'This style should have two \sbx sfms';}
.error-tc1-no-2-sbx {background:orange}
.error-c-needs-number-attrib::after {content:'This style needs a number attribute';}
