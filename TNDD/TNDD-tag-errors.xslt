...
.err-cell-tc1-needs-1-tbb::after {content:'This \\tc1 SFM should have one \\tbb __\tbb* SFM #2';}
.err-cell-tc1-needs-1-tbb {background:orange}
.err-cell-tc1-needs-2-sbx::after {content:'This \\tc1 SFM should have two \\sbx SFMs #3';}
.err-cell-tc1-needs-2-sbx {background:orange}
.err-char--space-b4-close-sfm::after {content:'There is a space before the closing SFM. Best to put the space after the close. #19';}
.err-char--space-b4-close-sfm {background:orange}
.err-char--empty-text::after {content:'This character SFM is empty #20';}
.err-char--empty-text {background:orange}
.err-char--not-marked-embedded::after {content:'This SFM is embedded in another character SFM and does not start with a +. #21';}
.err-char--not-marked-embedded {background:orange}
.err-char--not-embedded-but-marked-emb::after {content:'This character SFM is marked as embedded but is not in another character SFM. #22';}
.err-char--not-embedded-but-marked-emb {background:orange}
.err-char--not-closed::after {content:'This character SFM is not closed. No end marker was found. #23';}
.err-char--not-closed {background:orange}
.err-char-brk-pre-text-not-space::after {content:'This \\brk SFM is not preceded by a space. #10';}
.err-char-brk-pre-text-not-space {border-left:5pt solid red}
.err-char-brk-illegal-char::after {content:'This \\brk SFM can contain only ⌊ or ⌋ but this does not match either of those. #4';}
.err-char-brk-illegal-char {background:orange}
.err-char-brk-post-text-not-space-or-punc::after {content:'This \\brk SFM is not followed by a space or punctuation #5';}
.err-char-brk-post-text-not-space-or-punc {border-right:5pt solid red}
.err-char-brk-pre-not-imp::after {content:'This \\brk SFM should only occur immediately after an \\imp* SFM. #6';}
.err-char-brk-pre-not-imp {border-left:5pt solid red}
.err-char-brk-post-not-imp::after {content:'This \\brk* SFM should only occur immediately before an \\imp SFM. #7';}
...
.err-char-brk-post-is-space::after {content:'There should not be a space between \\imp* and \\brk #9';}
.err-char-brk-post-is-space {border-right:5pt solid red}
.err-char-imp-pre-not-bk::after {content:'This \\imp SFM should be preceded like this \\bk ⌊\\bk*\\imp...\\imp* #11';}
...
.err-char-imp-post-not-correct-bk-text::after {content:'This \\imp...\\imp* should be followed by \\bk ⌋\\bk* #14';}
.err-char-imp-post-not-correct-bk-text {border-right:5pt solid red}
.err-char-rgi-pre-not-punc::after {content:'This SFM should only occur after a punctuation character. #15';}
.err-char-rgi-pre-not-punc {border-left:5pt solid red}
.err-char-rgm-pre-not-punc::after {content:'This SFM should only occur after a punctuation character. #16';}
.err-char-rgm-pre-not-punc {border-left:5pt solid red}
...
.err-char-tbb-space-not-allowed::after {content:'There should not be a space after \tbb* SFM #18';}
.err-char-tbb-space-not-allowed {background:orange}
.err-para--no-content::after {content:'This paragraph marker is empty, and may not be allowed here. #41';}
...
.err-para-b-not-b4-table::after {content:'This \\b SFM is not allowed here, before a section header in \\tr. #24';}
.err-para-b-not-b4-table {border-bottom:2pt solid red}
.err-para-ml1-no-text-in-node::after {content:'There is no plain text in this paragraph. #25';}
.err-para-ml1-no-text-in-node {border-bottom:2pt solid red}
.err-para-ml1-pre-1-not-sl1-or-mlor::after {content:'The paragraph before this paragraph should be \\sl1 or \\mlor #26';}
.err-para-ml1-pre-1-not-sl1-or-mlor {border-top:2pt solid red}
.err-para-ml1-no-tbb-following-tr::after {content:'There is no ¶\\tbb __\\tbb* in this paragraph. It follows a section header \\tr so it is required. #27';}
.err-para-ml1-no-tbb-following-tr {border-bottom:2pt solid red}
.err-para-ml1-pre-has-tbb::after {content:'The preceding \\ml1 has a ¶\\tbb __\\tbb* so this one should too. #28';}
...
.err-para-ml1-when-tbb-not-node1-para-mark::after {content:'A Paragraph marker ¶ should occur before the \\tbb #30';}
.err-para-ml1-when-tbb-not-node1-para-mark {border-bottom:2pt solid red}
.err-para-ml1-child-but-no-text::after {content:'This \\ml1 paragraph has only character SFMs but no text. #31';}
.err-para-ml1-child-but-no-text {border-bottom:2pt solid red}
.err-para-ml1-no-text-or-child::after {content:'This \\ml1 should not be empty. If there is no content, remove it and the \\mlor preceding it. #32';}
.err-para-ml1-no-text-or-child {border-bottom:2pt solid red}
.err-para-mlor-pre2-not-ml1-allow-rem::after {content:'A \\ml1 should preceed the \\rem  that preceeds this \\mlor. #33';}
...
.err-para-mlor-text-not-lc-or::after {content:'The content of this \\\mlor SFM can only be: -or- #35';}
...
.err-para-mlor-post-not-ml1::after {content:'There is no following \\ml1 line following this \\mlor. Delete this line or addd a \\ml1 line #37';}
.err-para-mlor-post-not-ml1 {border-bottom:2pt solid red}
.err-para-p-not-allowed-here::after {content:'This paragraph SFM is not allowed here. #38';}
.err-para-p-not-allowed-here {border-bottom:2pt solid red}
.err-para-p-pre-p-para-not-allowed::after {content:'The preceding \\p is not allowed here. #39';}
.err-para-p-pre-p-para-not-allowed {border-top:2pt solid red}
.err-para-sl1-post-1-not-ml1::after {content:'The paragraph following this paragraph should be \\ml1 or \\sla #40';}
.err-para-sl1-post-1-not-ml1 {border-bottom:2pt solid red}
.err-row-tr-only-tc1-allowed::after {content:'Must have only one child \\tc1 #43';}
.err-row-tr-only-tc1-allowed {border-bottom:2pt solid red}
.err-row-tr-2nd-not-allowed::after {content:'Only one \\tr is allowed in this positions. #44';}
.err-row-tr-2nd-not-allowed {border-bottom:2pt solid red}
.err-table--only-1-tr-allowed::after {content:'There should only be one \\tr here. #45';}
   ...
   <xsl:template match="char">
      <xsl:element name="span">
         <xsl:attribute name="class">
            ...
            <xsl:if test="child::char">
               <xsl:if test="not(substring(@style,1,1) = '+')">
                  <xsl:text> err-char--not-marked-embedded</xsl:text>
               </xsl:if>
            </xsl:if>
            <xsl:if test="not(child::char)">
               <xsl:if test="substring(@style,1,1) = '+'">
                  <xsl:text> err-char--not-embedded-but-marked-emb</xsl:text>
               </xsl:if>
            </xsl:if>
   ...
   <xsl:template match="char[@style = 'brk']">
      <xsl:element name="span">
         <xsl:attribute name="class">
            ...
            <xsl:if test="contains(text(),'⌊') and position() &gt; 1 and preceding-sibling::*[1][@style != 'tbb']">
      ...
      <xsl:element name="span">
         <xsl:attribute name="class">
            ...
            <xsl:if test="preceding-sibling::node()[1] = preceding-sibling::text()[1]">
               <xsl:if test="translate(substring(preceding-sibling::text()[1],string-length(preceding-sibling::text()[1]),1),'+,.?!:;','_++++++') != '+'">
