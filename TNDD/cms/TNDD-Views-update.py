# TNDD Views Update for Paratext
...
commandstring = "echo set action=updateviews > " + actionbatchfile
os.system(commandstring)
commandstring = "echo set matchstart=" + matchstart + ">> " + actionbatchfile
os.system(commandstring)
commandstring = "echo set baseurl=" + baseurl + ">> " + actionbatchfile
os.system(commandstring)
commandstring = "echo set filelist=" + filelist + ">> " + actionbatchfile
os.system(commandstring)
