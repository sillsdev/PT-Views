...
rem @echo off
set viewsappdata=C:\Users\Public\PT-TN-Views
...
:: Usage: call :updateall
 ...
 rem the following is only for testing.
  ...
  set curlist=%installpath%\TN-Public-list.txt
  call :neededdir

  call curl -o "%curlist%"  --ssl-no-revoke %url-base%/TN-Public-list.txt
