...
@echo.
set zipfile=..\Installers\TN-Views.zip
if exist "%zipfile%" del "%zipfile%"
7z a -tzip "%zipfile%" @TN-Public-list.txt
goto :eof
...
call :date
call :created
copy docs\TN-Views.md+docs\TN-Views-install.md+docs\TN-Views-custom.md+docs\TNDD-info.md+docs\TNND-info.md+docs\USX-info.md+docs\SFM-info.md+docs\release-notes.md+docs\credits.md+docs\created.md tmp\%view%-final.md
