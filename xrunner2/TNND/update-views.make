...
$(ptxspath)/Views/TNND-tag-errors.xslt: scripts/TNND-tag-errors.xslt
	@echo %cyan%Copying: Project TNND-tag-errors.xslt to PT/Views%reset%
	@copy scripts\TNND-tag-errors.xslt "$(ptxpath)\Views\" > nul

$(gh-slocal)/TNND/TNND-tag-errors.xslt: scripts/TNND-tag-errors.xslt
	@echo %cyan%Copying: Project TNND-tag-errors.xslt to local Github project%reset%
	@copy scripts\TNND-tag-errors.xslt $(gh-local)\TNND\ > nul

$(ptxspath)/Views/TNND-tag-errors.xslt.txt: scripts/TNND-tag-errors.xslt
	@echo %cyan%Copying: Project TNND-tag-errors.xslt to PT/Views as .txt file to share%reset%
	@copy scripts\TNND-tag-errors.xslt "$(ptxpath)\Views\TNND-tag-errors.xslt.txt" > nul

$(ptxspath)/Views/TNND-word-count.xslt: scripts/TNND-word-count.xslt
	@echo %cyan%Copying: Project TNND-word-count.xslt to PT/Views%reset%
	@xcopy /D scripts\TNND-word-count.xslt "$(ptxpath)\Views\" > nul
	@echo %cyan%Copying: Project TNND-word-count.xslt to PT/Views as .txt file to share%reset%
	@xcopy /D scripts\TNND-word-count.xslt "$(ptxpath)\Views\TNND-word-count.xslt.txt" > nul
	
$(gh-slocal)/TNND/TNND-word-count.xslt: scripts/TNND-word-count.xslt
	@echo %cyan%Copying: Project TNND-word-count.xslt to local Github project%reset%
	@copy scripts\TNND-word-count.xslt "$(gh-local)\TNND\" > nul
...
$(gh-slocal)/xrunner2/TNND/scripts/data2xslt-cur.xslt: scripts/data2xslt-cur.xslt
	@echo %cyan%Copying: Project data2xslt-cur.xslt to local Github project%reset%
	@copy scripts\data2xslt-cur.xslt "$(gh-local)\xrunner2\TNND\scripts\" > nul
...
$(gh-slocal)/xrunner2/TNND/scripts/TNND-tag-errors.make: TNND-tag-errors.make
	...
	@copy TNND-tag-errors.make "$(gh-local)\xrunner2\TNND\" > nul
...
$(gh-slocal)/xrunner2/TNND/scripts/update-views.make: update-views.make
	...
	@copy update-views.make "$(gh-local)\xrunner2\TNND\" > nul

scripts/TNND-tag-errors.xslt: ;

scripts/data2xslt-cur.xslt: ;

scripts/TNND-word-count.xslt: ;
